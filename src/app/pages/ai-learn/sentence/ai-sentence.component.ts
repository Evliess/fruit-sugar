...
export class AiSentenceComponent implements OnInit {
  userInput = '';
  aiResponse = '';
  isLoading = false;
  chatMessages: ChatMessage[] = [];
  private readonly STORAGE_KEY = 'ai_sentence_chat_history';
  ...
  sendToAI(): void {
    ...
    this.sugarDictService.getSmartSentence(userInput, this.currentUser()?.id || -1).subscribe({
      next: (resp: any) => {
